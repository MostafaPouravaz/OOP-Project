...
public abstract class User {
    ...
    public static void saveUserToFile(){
        try {
            FileWriter fileWriterCustomer = new FileWriter("C:\\Users\\Mostafa\\IdeaProjects\\OOP-Project1\\oop\\files\\customers.json");
            ...
            FileWriter fileWriterVendor = new FileWriter("C:\\Users\\Mostafa\\IdeaProjects\\OOP-Project1\\oop\\files\\vendors.json");
            allU = new ArrayList<>();
            for (User allUser : allUsers) {
    ...
    public static ArrayList<User> loadUserFromFile(){
        try {
            ...
            fileReaderCustomer = new FileReader("C:\\Users\\Mostafa\\IdeaProjects\\OOP-Project1\\oop\\files\\customers.json");
